...
# ==============================================================================
# 1. CUSTOM CSS (INSPIRADO NO MODELO DA IMAGEM)
# ==============================================================================
css = """
<style>
    ...
    :root {
        --bg-color: #eef2f5;
        --sidebar-bg: #1ab394; /* Verde principal da foto */
        --card-bg: #e6ecef;
        --text-dark: #2c3e50;
        --accent: #1ab394;
        --danger: #e74a3b;
    ...
    /* IDENTIDADE DA BARRA LATERAL (Toda Verde) */
    ...
    .stSelectbox > div[data-baseweb="select"] > div {
        background-color: #148b73 !important;
...
# Lista de Obras para o filtro (Mesclando o que existe nos dois)
lista_obras = sorted(list(set(df_orcado['Obra'].unique()) | set(df_realizado['Obra'].unique())))
if '0' in lista_obras: lista_obras.remove('0')
if 'DIVERSAS' in lista_obras: lista_obras.remove('DIVERSAS')
if 'SEGUROS' in lista_obras: lista_obras.remove('SEGUROS')

# ==============================================================================
# 4. BARRA LATERAL (FILTROS VERDES ESTILO IMAGEM)
# ==============================================================================
with st.sidebar:
    st.image("https://cdn-icons-png.flaticon.com/512/1004/1004996.png", width=60) # Logo placeholder
    st.markdown("## FILTROS")
...
# Filtra sujeiras
df_matriz = df_matriz[(df_matriz['Obra'] != '0') & (df_matriz['Obra'] != '')]
