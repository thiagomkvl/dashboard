...
<style>
    ...
    .tabela-container-scroll { overflow-x: hidden; overflow-y: auto; max-height: 865px; border: 1px solid var(--border); border-radius: 9px; background: var(--surface); box-shadow: 0 2px 8px rgba(0, 138, 140, 0.04); font-size: 11px; width: 100%; margin-bottom: 8px; }
