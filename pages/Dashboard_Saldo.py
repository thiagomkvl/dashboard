...
<style>
    ...
    /* KPIs (5 COLUNAS COM IDENTIDADE VISUAL UNIFICADA) */
    ...
    .kpi-card.resultado { background: linear-gradient(135deg, #005F60, #003F40); } /* Alinhado à paleta teal */
...
# ==============================================================================
# 4. CARGA DE DADOS (V14)
# ==============================================================================
@st.cache_data(ttl=60)
def carregar_dados_matriz_fluxo_v14(ano):
...
try:
    res = carregar_dados_matriz_fluxo_v14(ano_selecionado)
    if len(res) == 3:
...
# BLOCO DE RESULTADOS (COM A LÓGICA EXATA PARA A COLUNA TOTAL)
